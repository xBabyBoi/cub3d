...
/*   Updated: 2025/10/18 15:55:54 by outourmi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void parse_info(s_cub_info *info)
{
    ...
    if(format_check(info->north, ".xpm") == 1 || format_check(info->south, ".xpm") == 1 || format_check(info->west, ".xpm") == 1 || format_check(info->east, ".xpm") == 1)
